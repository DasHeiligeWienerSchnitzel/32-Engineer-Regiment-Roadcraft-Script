...
_demolishment = true;
_object setVariable ["ER32_roadbuilder_demolishmentState", _demolishment, true];
	...
	*/
	
	{
		[_x] spawn {
			...
			[_terrainObject,true] remoteExec ["hideObjectGlobal",0];
		};
	...
	_demolishment = _object getVariable ["ER32_roadbuilder_demolishmentState", true];
